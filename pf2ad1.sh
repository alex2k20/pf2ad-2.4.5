...
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/alex2k20/pf2ad-2.5.1/master/samba.inc
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/alex2k20/pf2ad-2.5.1/master/samba.xml
...
cd /usr/local/pkg
fetch -o - -q https://raw.githubusercontent.com/alex2k20/pf2ad-2.5.1/master/squid_winbind_auth.patch | patch -b -p0 -f
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/alex2k20/pf2ad-2.5.1/master/squid.inc
