...
fetch -o /usr/local/pkg -q https://github.com/alex2k20/pf2ad-2.4.5/samba.inc
fetch -o /usr/local/pkg -q https://github.com/alex2k20/pf2ad-2.4.5/samba.xml
...
cd /usr/local/pkg
fetch -o - -q https://github.com/alex2k20/pf2ad-2.4.5/squid_winbind_auth.patch | patch -b -p0 -f
fetch -o /usr/local/pkg -q https://github.com/alex2k20/pf2ad-2.4.5/squid.inc
